							...
							<div class="best-selling-products p-3 mb-3">
								<div class="d-flex align-items-center">
									<div class="product-img">
										<img src="<?=base_url()?>assets/images/icons/ice-cream-cornet.png" class="p-1" alt="" />
									</div>
									<div class="ps-3">
								...
								<div class="d-flex align-items-center">
									<div class="product-img">
										<img src="<?=base_url()?>assets/images/icons/wine-glass.png" class="p-1" alt="" />
									</div>
									<div class="ps-3">
								...
								<div class="d-flex align-items-center">
									<div class="product-img">
										<img src="<?=base_url()?>assets/images/icons/banana.png" class="p-1" alt="" />
									</div>
									<div class="ps-3">
								...
								<div class="d-flex align-items-center">
									<div class="product-img">
										<img src="<?=base_url()?>assets/images/icons/telephone.png" class="p-1" alt="" />
									</div>
									<div class="ps-3">
								...
								<div class="d-flex align-items-center">
									<div class="product-img">
										<img src="<?=base_url()?>assets/images/icons/plate.png" class="p-1" alt="" />
									</div>
									<div class="ps-3">
								...
								<div class="d-flex align-items-center">
									<div class="product-img">
										<img src="<?=base_url()?>assets/images/icons/ice-cream-cornet.png" class="p-1" class="" alt="" />
									</div>
									<div class="ps-3">
										<h6 class="mb-0 font-weight-bold">Cone Ice Cream</h6>
										<p class="mb-0 text-secondary">$29/Each 56 Orders</p>
					...
					<div class="card radius-10 w-100">
						<div class="card-body">
							...
							<div class="support-list p-3 mb-3">
								...
								<div class="d-flex align-items-top">
									<div class="">
										<img src="<?=base_url()?>assets/images/avatars/avatar-2.png" width="45" height="45" class="rounded-circle" alt="" />
									</div>
									<div class="ps-2">
								...
								<div class="d-flex align-items-top">
									<div class="">
										<img src="<?=base_url()?>assets/images/avatars/avatar-3.png" width="45" height="45" class="rounded-circle" alt="" />
									</div>
									<div class="ps-2">
								...
								<div class="d-flex align-items-top">
									<div class="">
										<img src="<?=base_url()?>assets/images/avatars/avatar-4.png" width="45" height="45" class="rounded-circle" alt="" />
									</div>
									<div class="ps-2">
								...
								<div class="d-flex align-items-top">
									<div class="">
										<img src="<?=base_url()?>assets/images/avatars/avatar-5.png" width="45" height="45" class="rounded-circle" alt="" />
									</div>
									<div class="ps-2">
