...
<!-- Mirrored from codervent.com/synadmin/demo/vertical/index3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 02 Mar 2025 14:13:10 GMT -->
<head>
	<!-- Required meta tags -->
	<meta charset="utf-8">
	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
				<li>
					<a href="<?=base_url()?>home/index" class="has-arrow">
					...
					<div class="user-box dropdown px-3">
						...
						<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							...
							<div class="user-info ps-3">
								<p class="user-name mb-0">Aachal Gupta</p>
								<p class="designattion mb-0">Web Devloper</p>
							</div>
						</a>
						<ul class="dropdown-menu dropdown-menu-end">
							...
							<li><a class="dropdown-item" href="<?=base_url('home/logout')?>"><i class='bx bx-log-out-circle'></i><span>Logout</span></a>
							</li>
						</ul>
					</div>
				</nav>
